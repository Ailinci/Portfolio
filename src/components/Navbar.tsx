...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-900 text-gray-100 border-b border-pink-800/20 fixed w-full top-0 left-0 z-50 shadow-lg">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {menuItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="text-gray-300 hover:text-pink-400 transition-colors duration-200 text-xl font-medium"
              >
                {item.label}
              </a>
            ))}
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              {menuItems.map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                  className="text-gray-300 hover:text-pink-400 block px-3 py-2 rounded-md text-xl font-medium"
